...
const GrowthTools: FC = () => {
  return (
    <div className="bg-white p-4 rounded-xl shadow-md">
      <h2 className="text-xl font-bold mb-4 text-gray-900 py-4">Découvrez vos outils pour gagner des points de croissance</h2>
      <div className="grid grid-cols-2 gap-4">
        {/* Carte 1 */}
        <div className="relative bg-white border rounded-2xl shadow-sm p-7 pt-10">
          ...
          <Button className="mt-4 bg-blue-600 text-white py-3 w-full text-lg rounded-lg">Évaluer mes commerciaux</Button>
        ...
        <div className="relative bg-white border rounded-2xl shadow-sm p-7 pt-10">
          ...
          <Button className="mt-4 bg-blue-600 text-white w-full text-lg rounded-lg">Évaluer mes commerciaux</Button>
          {/* Image en haut à droite */}
